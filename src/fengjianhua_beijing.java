...
public class fengjianhua_beijing {
	...
	fengDataset_beijing ds;
	
	public fengjianhua_beijing(int K,int I)
	{
		this.K = K;
		this.I = I;
		ds= new fengDataset_beijing();
		//utrain=ds.utrain;
...
//				System.out.println("Y="+Y);
				fengjianhua_beijing jh = new fengjianhua_beijing(K,Y);
				jh.initialize();
...
//				Output.printTopic2("C:/Users/dz/Desktop/douban_shanghai/lamdaUS.txt", model.lambdaU, 20);				
				...
				String recfile="fengresult/beijing/efx1000/reccateK"+K+"Y"+Y+"_efx1000_5000.txt";//
				String recfilenorm="fengresult/beijing/efx1000/reccateK"+K+"Y"+Y+"norm_efx1000_5000.txt";
				
				String recfile2="fengresult/beijing/efx1000/reccateK"+K+"Y"+Y+"_600+score_5000.txt";//
				String recfilenorm2="fengresult/beijing/efx1000/reccateK"+K+"Y"+Y+"norm_600+score_5000.txt";
				
				String recfile3="fengresult/beijing/efx1000/reccateK"+K+"Y"+Y+"_600_negative_5000.txt";//
				String recfilenorm3="fengresult/beijing/efx1000/reccateK"+K+"Y"+Y+"norm_600_negative_5000.txt";
